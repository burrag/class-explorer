...
class GlobClassExplorerTest extends TestCase
{
    ...
    {
        $explorer = new GlobClassExplorer('\\TheCodingMachine\\ClassExplorer\\', new Psr16Cache(new NullAdapter()), null, null, true, __DIR__.'/../..');
    ...
    {
        $explorer = new GlobClassExplorer('\\TheCodingMachine\\ClassExplorer\\', new Psr16Cache(new NullAdapter()), null, null, false, __DIR__.'/../..');
        $classes = $explorer->getClasses();
    ...
    {
        $explorer = new GlobClassExplorer('\\TheCodingMachine\\ClassExplorer\\Glob\\', new Psr16Cache(new NullAdapter()), null, ClassNameMapper::createFromComposerFile(null, null, true), true, __DIR__.'/../..');
        $classes = $explorer->getClasses();
    ...
    {
        $explorer = new GlobClassExplorer('\\TheCodingMachine\\ClassExplorer\\Glob\\Foobar\\', new Psr16Cache(new NullAdapter()), null, null, true, __DIR__.'/../..');
        $classes = $explorer->getClasses();
